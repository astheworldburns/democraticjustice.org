...
export function createProofCard(data = {}) {
  ...
  const shareImagePath = `/assets/images/share-cards/${slug}.jpg`;
  ...
  return {
    ...
    articleUrl,
    featuredImage: normalizeWhitespace(data.featured_image || data.featuredImage),
    featuredImageAlt: normalizeWhitespace(data.featured_image_alt || data.featuredImageAlt),
    siteTitle,
    issue,
    axioms,
    postulates,
