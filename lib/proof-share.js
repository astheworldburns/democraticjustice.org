...
export async function renderProofShareImage(proofCard, outputDir, options = {}) {
  ...
  const footerFacts = `${proofCard.axiomCount} sourced axioms · ${proofCard.logicCount} reasoning steps`;
  const conclusionFontSize = conclusionSource.length > 145 ? 40 : conclusionSource.length > 110 ? 46 : 54;
  const conclusionLineHeight = conclusionSource.length > 145 ? 1.02 : 1.04;
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style="color:#23354e;">Published Proof</span>
        </div>
